!function(t, e) {
    ...
    var v = function() {
      ...
      , E = function() {
        ...
        return i(e, [{
            ...
            value: function() {
                this.isVisible = !0,
                this.element.classList.remove(g.HIDDEN),
                this.element.classList.add(g.VISIBLE),
            ...
            value: function() {
                this.isVisible = !1,
                this.element.classList.remove(g.VISIBLE),
                this.element.classList.add(g.HIDDEN),
                this.element.setAttribute("aria-hidden", !0)
            }
        }, {
            key: "init",
            value: function() {
                this.addClasses([g.SHUFFLE_ITEM, g.VISIBLE]),
            ...
            key: "dispose",
            value: function() {
                this.removeClasses([g.HIDDEN, g.VISIBLE, g.SHUFFLE_ITEM]),
    ...
    function T(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null)
          , n = m(i[e]);
        return b() || "width" !== e ? b() || "height" !== e || (n += m(i.paddingTop) + m(i.paddingBottom) + m(i.borderTopWidth) + m(i.borderBottomWidth)) : n += m(i.paddingLeft) + m(i.paddingRight) + m(i.borderLeftWidth) + m(i.borderRightWidth),
        n
    }
    var S = {
        reverse: !1,
    ...
    var w = {}
      ...
      , L = 0;
    function D(t) {
        return !!w[t] && (w[t].element.removeEventListener(C, w[t].listener),
        w[t] = null,
        !0)
    }
    function z(t, e) {
        var i = C + (L += 1)
          , n = function(t) {
            t.currentTarget === t.target && (D(i),
            e(t))
        };
        return t.addEventListener(C, n),
        w[i] = {
            element: t,
            listener: n
        },
    ...
    var N = 0
      , B = function(e) {
        ...
        function o(e) {
            ...
            t(this, o),
            (i = n.call(this)).options = Object.assign({}, o.options, s),
            i.options.delimeter && (i.options.delimiter = i.options.delimeter),
            i.lastSort = {},
            i.group = o.ALL_ITEMS,
            i.lastFilter = o.ALL_ITEMS,
            i.isEnabled = !0,
            i.isDestroyed = !1,
            i.isInitialized = !1,
            i._transitions = [],
        ...
        return i(o, [{
            ...
            value: function(t, e) {
                var i;
                return 0 === (i = "function" == typeof this.options.columnWidth ? this.options.columnWidth(t) : this.options.sizer ? o.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : this.items.length > 0 ? o.getSize(this.items[0].element, !0).width : t) && (i = t),
                i + e
            }
        }, {
            key: "_getGutterSize",
            ...
            value: function(t) {
                ...
                t.forEach((function(t, s) {
                    ...
                    if (v.equals(t.point, i[s]) && !t.isHidden)
                        return t.applyCss(E.Css.VISIBLE.before),
                        void o();
                    t.point = i[s],
            ...
            value: function(t) {
                return function(t) {
                    for (var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, o = t.threshold, r = t.buffer, l = A(e.width, n, s, o), a = F(i, l, s), u = x(a, r), h = new v(n * u,a[u]), f = a[u] + e.height, c = 0; c < l; c++)
                        i[u + c] = f;
                    return h
                }({
                    itemSize: t,
            ...
            value: function() {
                ...
                e.forEach((function(e) {
                    ...
                    if (e.isHidden)
                        return e.applyCss(E.Css.HIDDEN.before),
                        void n();
                    e.scale = E.Scale.HIDDEN,
                    e.isHidden = !0;
            ...
            value: function() {
                ...
                this._dispatch(o.EventType.LAYOUT)) : this._dispatch(o.EventType.LAYOUT),
            ...
            key: "filter",
            value: function(t, e) {
                this.isEnabled && ((!t || t && 0 === t.length) && (t = o.ALL_ITEMS),
                this._filter(t),
                this._shrink(),
    ...
    return B.ShuffleItem = E,
    B.ALL_ITEMS = "all",
    B.FILTER_ATTRIBUTE_KEY = "groups",
    B.EventType = {
    ...
    B.__sorter = k,
    B.__getColumnSpan = A,
    B.__getAvailablePositions = F,
    B.__getShortColumn = x,
    B.__getCenteredPositions = O,
    B
}
));
