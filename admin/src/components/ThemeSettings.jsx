...
//In this component, we need to change the global state. Once we change colors in this component, the change must be seen across entire application. 
    ...
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:bg-[#484B52] w-400'>
        <div className='flex justify-between items-center p-4 ml-4'>
          ...
          <button
            type='button'
            onClick={() => setThemeSettings(false)} //close the settings
            style={{
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
          ...
          <div className='mt-4'>
            <input
              ...
              onChange={setMode}
              checked={currentMode === 'Light'} //check if the current mode is light
            />
          ...
          <div className='mt-2'>
            <input
              ...
              className='cursor-pointer'
              onChange={setMode}
              checked={currentMode === 'Dark'} //check if the current mode is dark
            />
