            ...
            <section className="banner key-banner banner--secondary clear__top bg__img"
                ...
                <div className="container">
                    <div className="banner__area">
                        <h1 className="neutral-top">Key risks</h1>
                ...
                <img src="assets/images/banner/key-illustration.png" alt="Career" className="banner__thumb" />
            </section>
            {/* <!-- ==== #banner section end ==== --> */}
                ...
                <div className="container">
                    <div className="key-faq__area">
                        <div className="section__header">
                            ...
                            <p className="neutral-bottom">Investing in property can be rewarding but, as with any investment there
                                are risks.
                                The Info Packs and the Investment Terms and Conditions cover the risks specific to a particular
                                investment but it is also important that, before investing, you understand the following general
                                risks..</p>
                        </div>
